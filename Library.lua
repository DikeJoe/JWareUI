...
local function InitJWareUI()
	...
	local function CreateWindow(opts)
		...
		function Window:Watermark(state)
				...
				function Section:AddDropdown(cfg)
					...
					return {
						...
						Refresh = function(newOptions)
							...
							local newHeight = math.min(#cfg.Options * 20, 160)

							ListFrame.Size = UDim2.new(0, 208, 0, newHeight)

							ListScroll.CanvasSize =
								UDim2.new(0, 0, 0, #cfg.Options * 20)

							ListScroll.ScrollBarThickness =
								(#cfg.Options * 20 > newHeight) and 4 or 0
							...
							for _, optName in ipairs(cfg.Options) do
								...
								wrapper.MouseEnter:Connect(function()
									tween(optLbl,{TextColor3=COL_TEXT_HOVER})
								end)

								wrapper.MouseLeave:Connect(function()
									tween(optLbl,{TextColor3=COL_TEXT_NORMAL})
								end)
								...
								table.insert(optButtons,{
									Name = optName,
									Label = optLbl
								})
							end

							DropTitle.Text = cfg.Placeholder
						end,
					}
				end
